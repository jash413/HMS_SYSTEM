...
function OTScheduleForm() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Implement logic to submit form data to the backend
      ...
      <ul className="menu-list flex-grow-1 mt-3">
        ...
        <li className="collapsed">
          ...
          <ul className="sub-menu collapse show" id="page">
            ...
            <li><a className="ms-link active" href="forms.html"> Forms Example</a></li>
          ...
          <div className="col-md-12">
            <div className="card mb-3">
              <div className="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                <h6 className="mb-0 fw-bold ">Patient's Details</h6> 
              </div>
              <div className="card-body">
                <form>
                  <div className="row g-3 align-items-center">
                    ...
                    <div className="col-md-6">
                      <label htmlFor="admitdate" className="form-label">Date of Surgery</label>
                      <input type="date" className="form-control" id="admitdate" required />
                    </div>
                    <div className="col-md-6">
                      <label htmlFor="admittime" className="form-label">Time of Surgery</label>
                      <input type="time" className="form-control" id="admittime" required />
                    </div>                  
                    <div className="col-md-12">
                      <label htmlFor="addnote" className="form-label">Details about Surgery(if any)</label>
