...
function SurgerySchedulingForm() {
  ...
  const fetchAvailableSurgeons = async (startTime, endTime, date) => {
    try {
      const response = await axios.get(
        `http://15.207.55.158:3100/available-resources?startTime=${startTime}&endTime=${endTime}&selectedDate=${date}`,{
          headers: {
  ...
  const fetchAnaesthetists = async () => {
    try {
      const response = await axios.get("http://15.207.55.158:3100/anaesthetists",{
        headers: {
          authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchAvailableSlots = async () => {
    try {
      const response = await axios.get(
        `http://15.207.55.158:3100/common-available-slots?doctorId=${formData1.selectedSurgeon}&anaesthetistId=${formData1.selectedAnaesthetist}&theatreId=${formData1.selectedTheatre}&date=${formData1.selectedDate}&duration=${formData1.selectedDuration}`,{
          headers: {
            authorization: `Bearer ${token}`,
          },
        }
  ...
  const fetchSelectedSurgeon = async () => {
    try {
      const response = await axios.get(
        `http://15.207.55.158:3100/doctors/${formData.selectedSurgeon}`
      ,{
        headers: {
          authorization: `Bearer ${token}`,
        },
  ...
  const fetchSelectedAnaesthetist = async () => {
    try {
      const response = await axios.get(
        `http://15.207.55.158:3100/anaesthetists/${formData.selectedAnaesthetist}`
      ,{
        headers: {
          authorization: `Bearer ${token}`,
        },
  ...
  const fetchSelectedTheatre = async () => {
    try {
      const response = await axios.get(
        `http://15.207.55.158:3100/operation-theatres/${formData.selectedTheatre}`
      ,{
        headers: {
          authorization: `Bearer ${token}`,
        },
  ...
  const fetchSelectedKit = async () => {
    try {
      const response = await axios.get(
        `http://15.207.55.158:3100/ot-kits/${formData.selectedKit}`
      ,{
        headers: {
          authorization: `Bearer ${token}`,
        },
  ...
  const handleConsentForm = async () => {
    try {
      ...
      const response = await axios.post(
        "http://15.207.55.158:3100/generate-consent-form",
        {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Perform submission logic here
      const response = await axios.post("http://15.207.55.158:3100/surgeries", {
        surgeryType: selectedSurgeryType,
        start_time: formData.selectedStartTime,
        end_time: formData.selectedEndTime,
        doctor_id: formData.selectedSurgeon,
